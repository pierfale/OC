...
class HillClimbingProgramOption : public BasicProgramOption<Size> {

	typedef void(*SolverFunction)(const HillClimbingProgramOption<Size>& program_options, const DataInput<Size>&, DataOutput<Size>&);
...
public:
	...
	template<template<unsigned int> class Select, template<unsigned int> class Neighborhood, typename Init>
	static void hillClimbingSolverFunction(const HillClimbingProgramOption<Size>& program_options, const DataInput<Size>& input, DataOutput<Size>& output) {
